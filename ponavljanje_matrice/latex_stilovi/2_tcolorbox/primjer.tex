...
\begin{tcolorbox}[
    ...
    {\Large\bfseries\color{primary} Simulacija Šumskog Požara}\\[4pt]
    {\normalsize Matrični model širenja vatre \quad|\quad iobih škola — Radionica}
\end{tcolorbox}
...
\begin{kodbox}{Ključni dio koda — ažuriranje ćelija}
